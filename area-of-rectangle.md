...
## The Problem
In this problem, we have to find out the area of a rectangle. This problem will work on user input, which means that to find out the area of a rectangle, the width and length of the rectangle will be provided by the user.
...
[Click here for code](area-of-rectangle-(Structure).cpp)
